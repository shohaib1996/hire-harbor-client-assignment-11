...
const VideoSection = () => {
    ...
    return (
        <div className="mb-12 max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-5">
            <div className="lg:flex-[2] p-3 lg:p-0">
                <div className="relative ">
                    ...
                    <div className="absolute bottom-0 w-full bg-black bg-opacity-70 rounded-b-2xl text-white h-[120px] lg:h-[100px] flex justify-center gap-16 items-center">
                        <div className=" text-center text-xs lg:text-lg font-bold">
